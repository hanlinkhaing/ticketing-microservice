...
function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('[ADMIN_LOGIN] Starting login process:', { username: formData.username });
      ...
      console.log('[ADMIN_LOGIN] Login successful:', { username: formData.username });
      onLogin(data);
      navigate('/');
  ...
  return (
    <div className="login-container">
      <div className="card">
        <h2>Admin Login</h2>
        <p className="muted-text">Manage users, events, orders, and support from a single place.</p>
