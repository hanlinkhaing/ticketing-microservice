// Error handling utility for admin portal
...
// Centralized API service with error handling for admin portal
...
// Toast notification utility for admin portal
export const showErrorNotification = (error, serviceName) => {
  ...
  // Show in console
  console.error(`[ADMIN_NOTIFICATION] ${notificationMessage}`);
  
  // Also show alert for visibility during testing
  alert(`Admin Portal Error: ${notificationMessage}`);
